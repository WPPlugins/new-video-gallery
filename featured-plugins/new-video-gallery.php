	...
	class New_Video_Gallery {
		...
		*/
		...
		public function vg_upload_multiple_images($post) {
					...
					foreach($allimagesetting['slide-ids'] as $id) {
						...
						<li class="slide">
							...
							<select id="poster-type[]" name="poster-type[]" style="width: 100%;">
								...
								<option value="youtube" <?php if($poster_type == "youtube") echo "selected"; ?>>Fetch YouTube Poster</option>
								</optgroup>
							</select>
				...
				<br>
				<br>
				<h1>Copy Video Gallery Shortcode</h1>
				<hr>
		...
		public function _vg_ajax_callback_function($id) {
			...
			<li class="slide">
				...
				<select id="poster-type[]" name="poster-type[]" style="width: 100%;">
					...
					<option value="youtube">Fetch YouTube Poster</option>
					</optgroup>
				</select>
