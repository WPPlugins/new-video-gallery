	...
	<div class="panel panel-default">
		...
		<div id="collapse11" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading11">
			<div class="panel-body">	
				...
				<p class="">&nbsp;&nbsp;
					<a href="http://awplife.com/account/signup/video-gallery-premium" target="_blank" class="button button-primary  load-customize hide-if-no-customize">Upgrade To Pro</a>
				</p>
...
<hr><br><br>
	<p class="">&nbsp;&nbsp;
		<a href="http://awplife.com/account/signup/video-gallery-premium" target="_blank" class="button button-primary button-hero load-customize hide-if-no-customize">Buy Premium Version</a>
		<a href="http://demo.awplife.com/video-gallery-premium/" target="_blank" class="button button-primary button-hero load-customize hide-if-no-customize">Check Live Demo</a>
		<a href="http://demo.awplife.com/video-gallery-premium-admin-demo/" target="_blank" class="button button-primary button-hero load-customize hide-if-no-customize">Try Admin Demo</a>
	</p>
	<hr>
	<style>
		.awp_bale_offer {
